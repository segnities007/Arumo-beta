...
data class StorageEntity
    ...
    constructor(
        ...
        companion object {
            ...
            private fun intListToJson(list: List<Int>): String = Json.encodeToString(list)
            ...
            private fun editableUserIdsToJson(map: Map<String, Boolean>): String = Json.encodeToString(map)
